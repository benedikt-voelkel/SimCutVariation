...
setup(
  name='SimParameterVariationAnalysis',

  # LAST-TAG is a placeholder. Automatically replaced at deploy time with the right tag
  version='LAST-TAG',

  description='Analyse O2 simulation parameter variations',
  ...
  install_requires=[ "numpy", "pandas", "scipy", "matplotlib", "seaborn", "scikit-learn",
                     "xgboost==0.82", "keras", "tensorflow", "PyYaml", "pylint"],
  ...
  package_data={ "something1.data": [ "file1.yaml",
                                      "file2.yaml",
                                      "file3.yaml" ],
                 "something2.somewhereelse.data": [ "file1.html",
                                                    "file2.yaml",
                                                    "file3.css" ] },
  ...
  entry_points={
      "console_scripts": [ "run-par-simulation = run-sim:main",
                           "run-par-analysis = analysis:main" ]
  }
)
